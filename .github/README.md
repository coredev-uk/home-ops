...
| Lenovo ThinkCentre M720q (`hyperion-1`) | 1 | Intel Core i5-8400T | 16GB RAM | 1TB SSD (Ceph), 256GB SSD (Talos) | Kubernetes node | - |
| Lenovo ThinkCentre M920q (`hyperion-2`) | 1 | Intel Core i5-8500T | 16GB RAM | 1TB SSD (Ceph), 128GB SSD (Talos) | Kubernetes node | - |
